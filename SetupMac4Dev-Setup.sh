...
git config --global user.name "Peter Varga"
git config --global user.email petervarga@rocketmortgage.com
...
cd ~
git clone git@github.com:pvarga/dotfiles.git .dotfiles
cd .dotfiles
sh symdotfiles
